...
import { playlists } from '../assests/categories/categories';

const Playlists = () => {
  return (
    <div className=' xs:mt-16 bg-hero-pattern2  bg-cover bg-no-repeat bg-center'>
        <div className='xs:mx-auto xs:max-w-screen-xl'>

        <motion.div variants={textVariant()} className='ml-5' >
        <p className={styles.sectionSubText}>by loki</p>
        <h2 className={styles.sectionHeadText}>Playlists.</h2>
      </motion.div>

      <div class="main xs:w-[60%] w-[85%] mx-auto xs:mx-5 mb-0 ">
  ...
  <div class="song">
    ...
    <p class="artist">{item.songs} songs</p>
  </div>
  <div class="albumcover bg-cover bg-no-repeat bg-center" style={{ backgroundImage: `url(${item.img})`, transform: "scaleY(-1)" }}></div>
  <div class="play"></div>
  <div class="loading ">
    <div class="load"></div>
    <div class="load"></div>
